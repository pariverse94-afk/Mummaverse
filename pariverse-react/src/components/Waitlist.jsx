    ...
    <section id="waitlist" className="relative py-24 md:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div ref={ref} className="max-w-2xl mx-auto reveal">
          <div className="beam-container relative bg-[#F7EDE4] border border-[#8B7355]/10 rounded-2xl p-8 md:p-12 text-center overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-center gap-2 mb-6">
                ...
                <span className="font-oswald text-[15px] font-500 tracking-wider uppercase text-[#8B7355]">From Mummaverse</span>
              </div>
              ...
              <h2 className="font-oswald text-2xl md:text-3xl lg:text-4xl font-500 uppercase tracking-tight mb-3 text-[#2C1810]">Your Village is Waiting</h2>
